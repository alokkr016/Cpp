...
The keyword 'synchronized' in Java is used to control the
 execution of thread in a strict sequence. In the following, 
 the program is expected to print the output as given below.
  Do the necessary use of 'synchronized' keyword, so that, 
  the program prints the Final sum as given below: 
  Final sum:6000 */
...
//Complete the code given below , Use SynchroniZe at appropriate place

// Returns the sum of a and b. (reader)
//Sum Should always return an even number.
sum() {
